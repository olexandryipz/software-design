public class HeroBuilder : ICharacterBuilder
{
    ...
    public ICharacterBuilder AddGoodDeed(string deed) { _character.GoodDeeds.Add(deed); return this; }
    public ICharacterBuilder AddEvilDeed(string deed) { return this; }
